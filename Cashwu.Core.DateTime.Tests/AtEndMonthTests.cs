...
namespace Cashwu.Core.DateTime.Tests
{
    public class AtEndMonthTests
    {
        ...
        {
            var current = new System.DateTime(2019, 8, 1, 1, 00, 00, 000);
            var expected = new System.DateTime(2019, 8, 31, 1, 00, 00, 000);
        ...
        {
            var current = new System.DateTime(2019, 8, 31, 1, 00, 00, 000);
            var expected = new System.DateTime(2019, 8, 31, 1, 00, 00, 000);
        ...
        {
            var current = new System.DateTime(2019, 2, 5, 1, 00, 00, 000);
            var expected = new System.DateTime(2019, 2, 28, 1, 00, 00, 000);
        ...
        {
            var current = new System.DateTime(2020, 2, 5, 1, 00, 00, 000);
            var expected = new System.DateTime(2020, 2, 29, 1, 00, 00, 000);
